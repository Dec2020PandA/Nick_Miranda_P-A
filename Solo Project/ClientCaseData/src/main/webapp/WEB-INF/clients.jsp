...
<body>
<div class="container">
<h1>Client with the name - <c:out value="${name}"/></h1>
...
<div class="float-right">
	...
	<table class="table table-striped">
		...
		<tbody>
		<c:forEach items="${clientsByName}" var="client">
			<tr>	
			...
			<c:choose>
				<c:when test="${ clientByName.caseWorker.id == user.id }">
					<td><a href="/edit/${client.id}">Edit</a> | <a href="/client/delete/${client.id }">Delete</a></td>
				</c:when>
			</c:choose>
			</tr>
		</c:forEach>
